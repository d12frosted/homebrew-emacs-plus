...
#+begin_src bash
  $ brew tap d12frosted/emacs-plus
  $ brew install --cask emacs-plus@30   # Stable (Emacs 30)
  $ brew install --cask emacs-plus@31   # Development (Emacs 31)
#+end_src
...
| macOS versions       | 14+ (Sonoma, Sequoia, Tahoe) | Any supported         |
