...
** Table of Contents :TOC_3:
  ...
  - [[#features-explained][Features explained]]
    ...
    - [[#emacs-client-app][Emacs Client.app]]
...
Starting with =emacs-plus@30=, the formula includes a companion application called =Emacs Client.app=. This application provides a user-friendly way to open files in Emacs from Finder, Spotlight, and other macOS applications.
