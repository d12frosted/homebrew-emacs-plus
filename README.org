...
> :warning: It's important to note that any local changes to commits or branches within the cached repository won't impact the build process, as =brew= overrides the state of the cloned repository during installation.
