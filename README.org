...
#+begin_src bash
  ...
  $ brew install emacs-plus@master [options] # install Emacs master (alias for @31)
...
- =emacs-plus@master= alias for development version (currently Emacs 31).
...
- =emacs-plus@29= install Emacs 29, previous version.
  ...
  $ brew tap d12frosted/emacs-plus
  $ brew install emacs-plus        [options] # install the latest release (Emacs 30)
  $ brew install emacs-plus@master [options] # install Emacs master
...
For faster installation without compilation, pre-built binaries are available as Homebrew casks:

#+begin_src bash
  $ brew tap d12frosted/emacs-plus
  $ brew install --cask emacs-plus-app           # Stable (Emacs 30)
