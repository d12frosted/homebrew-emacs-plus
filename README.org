...
Please note, that ~--with-no-titlebar~ is no longer needed, the same can be achieved with [[https://github.com/d12frosted/homebrew-emacs-plus#no-titlebar][this method]].
